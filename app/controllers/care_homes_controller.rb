class CareHomesController < ApplicationController
  ...
  def care_home_params
    params.require(:care_home).permit(:name, :main_contact,:phone_number, :website, :address, :email, :address1, :address2, :city, :postcode, :type_of_home, :types_of_client_group, :short_description, photos: [])
  end
end
