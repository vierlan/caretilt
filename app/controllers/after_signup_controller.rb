class AfterSignupController < ApplicationController
  ...
  def onboarding_params(step = :add_name)
    ...
    when :add_company
      params.require(:company).permit(:name, :type, :companies_house_id, :registered_address, :phone_number, :contact_name, :email, :address1, :address2, :city, :postcode, :companies_house_id)
    when :add_local_authority
