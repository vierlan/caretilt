...
//     this.initLocationButton(); // Initialize the location button
//   }
...
//   initLocationButton() {
//     const locationButton = this.locationButtonTarget;
...
//             this.displayMapWithLocation(location);
//             this.updateFormWithCurrentLocation(lat, lng);
//           },
//           () => {
...
//   updateFormWithCurrentLocation(lat, lng) {
//     document.getElementById('latitude').value = lat;
//     document.getElementById('longitude').value = lng;

//     // Optionally, update the address display
//     const addressDetailsElement = document.getElementById('address-details');
//     addressDetailsElement.textContent = `Latitude: ${lat}, Longitude: ${lng}`;

//     // Show the confirm button to allow the user to confirm the current location
